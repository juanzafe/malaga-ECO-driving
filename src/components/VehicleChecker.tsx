...
export const VehicleChecker = ({ isFuture, isResident, onLabelCalculated }: VehicleCheckerProps) => {
  ...
  const calculateBadge = () => {
    ...
    if (fuel === 'electric') {
      ...
      else if (y > 2001 || (y === 2001 && m >= 1)) result = 'B';
      else result = 'SIN';
    } else if (fuel === 'diesel') {
      if (y > 2015 || (y === 2015 && m >= 9)) result = 'C';
      else if (y > 2006 || (y === 2006 && m >= 1)) result = 'B';
      else result = 'SIN';
    }
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-xl max-w-md mx-auto border border-slate-100">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-slate-800">Buscador de Distintivo</h2>
        {badge && (
           <button 
